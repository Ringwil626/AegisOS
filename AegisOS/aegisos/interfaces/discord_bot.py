...
async def evolve_command(interaction: discord.Interaction, goal: str):
    ...
    try:
        ...
        # Create proposal (AI generates patch) - pass task_id as first argument
        ...
        if os.path.exists(os.path.join(proposal_path, "REJECTED.txt")):
            status = "rejected (missing justification)"
